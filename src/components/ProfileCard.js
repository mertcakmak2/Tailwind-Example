            ...
            <div class="px-6">
                <div class="flex flex-wrap justify-center">
                    <div class="w-full flex justify-center">
                        <div class="relative">
                            <img src="https://media-exp1.licdn.com/dms/image/C4D03AQFltlB6neL2UQ/profile-displayphoto-shrink_800_800/0/1655898178338?e=1663200000&v=beta&t=uhLfq8Lt2J1PCFp9kwqMfstbpJRMDla5_zlrTChTvMI" alt='mertcakmak' class="shadow-xl rounded-full align-middle border-none absolute -m-16 -ml-20 lg:-ml-16 max-w-[150px]" />
                        </div>
                    </div>
                ...
                <div class="mt-6 py-6 border-t border-slate-200 text-center">
                    <div class="flex flex-wrap justify-center">
                        <div class="w-full px-4">
                            ...
                            <a href="http://mertcakmak.com" class="font-normal text-slate-700 hover:text-slate-400">Follow Account</a>
                        </div>
                    </div>
                </div>
            </div>
